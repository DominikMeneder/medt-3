		...
		<div class="container">
			<?php
				...
				if (isset($_GET['createProject']) || isset($_POST['createProject']))
				{
					...
					echo '<a href="index.php?logout">Abmelden</a>';
					echo '<a href="projectview.php" class="btn btn-info" role="button"><span class="glyphicon glyphicon-refresh"></span>Refresh</a><br><br>';
